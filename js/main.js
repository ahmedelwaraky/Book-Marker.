...
//countenteditable تعديل




//console.log(booksContainer.at(-1))
// function addBook(){
//     var book ={
//         name : siteName.value,
//         ulr : siteUrl.value,
//     }
//     // delete book.name ;   لحذف الname اللي جايه من back
//     // console.log("name" in book )   // هل البروبرتي دي موجود ف الاوبجيتك ولا لا
//     // console.log(JSON.stringify(book).includes ('ali'))   // بيقول حوله لاسترنج وهل يحتوي على اسم على ولا لا   
// }